...
export default function PageWrapper ({ profile, children }: any) {
    return (
        <main className="w-full flex flex-col justify-center items-start text-slate-500">
            <div className="border-b border-solid border-slate-800 w-full flex flex-col justify-center items-center px-6 md:px-8 sticky top-0 left-0 dark:bg-darkImg z-50">
