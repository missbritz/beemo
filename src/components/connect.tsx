...
const ConnectComponent = ({ social }: any) => {
    return (
        <div id="connect" className="mt-8 py-8 border-t border-solid border-slate-800">
            ...
            <p className="text-gray-400 max-w-prose my-2">Say <Emoji symbol="👋" /> at <a href="mailto:hello@britzoblan.com" className="text-gray-400 hover:text-pink-500 ">hello<strong>[at]</strong>britzoblan.com</a></p>
