...
const LabItems = ({ items }: any) => {
    ...
    return items.length ? items.map((lab:any) => {
        ...
        return (
            <Link href={lab.attributes.ProjectUrl} className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 md:max-h-60 overflow-hidden" target="_blank">
